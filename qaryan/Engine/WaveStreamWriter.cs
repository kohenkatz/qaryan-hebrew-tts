...
//
//    A modification of WaveFileWriter, a class originally by Colin Savage
...
namespace Qaryan.Audio
{
    class WaveStreamWriter
    {
        ...
        public WaveStreamWriter(Stream stream, ushort channels, uint samplesPerSecond, uint averageBytesPerSecond, ushort blockAlign, ushort bitsPerSample, bool writeHeader)
        {
            _stream = stream;

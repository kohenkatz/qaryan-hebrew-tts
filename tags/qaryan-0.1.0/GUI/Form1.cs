...
namespace Qaryan.GUI
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void âøóäðâðäToolStripMenuItem_Click(object sender, EventArgs e)
        {
            fujisakiForm.Show();
        ...
        private void àðâìéúToolStripMenuItem_Click(object sender, EventArgs e)
        {
            DialogResult res = DialogResult.No;
            if (textBox1.Modified)
                res = MessageBox.Show(Resources.SaveChangesQuery, Resources.AppName, MessageBoxButtons.YesNoCancel);
        ...
        private void ðé÷åãToolStripMenuItem_Click(object sender, EventArgs e)
        {
            nikudHelp.Show();
        }
